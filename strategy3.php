<?php
   $coin = "NZDT"; //what will be the base coin to play to. Effectively this bounds the screen to the DOGE market in cryptopia and only coins in this market.
   $coincap = 1; //how many coins to keep from $coin (not to play them)
   ...
   $targetprofit = 0.10; //target profit to make (sell order)
   $coinbet = 1.5; //increments of $coin to play
